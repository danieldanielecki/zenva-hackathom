(function (global) {
  var BlueEnemy = global.BlueEnemy = function (state, zenva) {
    ...
    this.animations.add('blue-enemy', Phaser.Animation.generateFrameNames('blue-enemy-', 0, 0, '.png', 0), 3, true, false); // Play animation in loop.

    // Add shooting animations.
    this.animations.add('blue-enemy-dead', Phaser.Animation.generateFrameNames('blue-enemy-', 0, 2, '.png', 0), 4, false, false); // Play animation once.

    this.animations.play('blue-enemy'); // Play sailing animation.
  ...
  BlueEnemy.prototype.killBlueEnemy = function () {
    ...
    if (this.health <= 0) {
      ...
      this.inputEnabled = false; // Disable input events.
        ...
        this.animations.play('blue-enemy-dead', null, false, true) // Play shooting left animation.
  ...
  BlueEnemy.prototype.boundOut = function (zenva) {
