(function (global) {
  var GreenEnemy = global.GreenEnemy = function (state, zenva) {
    ...
    this.animations.add('green-enemy', Phaser.Animation.generateFrameNames('green-enemy-', 0, 0, '.png', 0), 3, true, false); // Play animation in loop.

    // Add shooting animations.
    this.animations.add('green-enemy-dead', Phaser.Animation.generateFrameNames('green-enemy-', 0, 2, '.png', 0), 4, false, false); // Play animation once.

    this.animations.play('green-enemy'); // Play sailing animation.
  ...
  GreenEnemy.prototype.killGreenEnemy = function () {
    ...
    if (this.health <= 0) {
      ...
      this.inputEnabled = false; // Disable input events.
        ...
        this.animations.play('green-enemy-dead', null, false, true) // Play shooting left animation.
  ...
  GreenEnemy.prototype.boundOut = function (zenva) {
